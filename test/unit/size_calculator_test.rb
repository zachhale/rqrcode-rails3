...
class RQRCode::SizeCalculatorTest < ActiveSupport::TestCase
  ...
  test "size returned is 3 for 'http://guides.rubyonrails.org/testing.html' using size l" do
    assert_equal(3, minimum_qr_size_from_string('http://guides.rubyonrails.org/testing.html', :l))
  end
